...
function getSpinnerBackgroundStyle(spinnerType, customButtonStyle, defaultButtonStyle, spinnerOptions) {
  ...
  let width = height;
  let backgroundColor = customButtonStyle.backgroundColor
  ...
  let marginHorizontal = customButtonStyle.marginHorizontal
    ? customButtonStyle.marginHorizontal
    : defaultButtonStyle.margin;
...
const SpinnerComponent = (props) => {
  ...
  let customSpinnerStyle = getSpinnerBackgroundStyle(
    spinnerType,
    customButtonStyle,
    defaultButtonStyle,
    spinnerOptions
      ...
      return (
        <View
          ...
          <Animatable.View
            ...
            <BallIndicator color={spinnerColor || 'rgb(255, 255, 255)'} count={indicatorCount} size={height - 20} />
          </Animatable.View>
        </View>
      );
    case 'BarIndicator':
      return (
        <View
          ...
          <Animatable.View
            animation={animationType || 'fadeIn'}
            style={[styles.defaultSpinnerContainerStyle, customSpinnerStyle]}>
            <BarIndicator color={spinnerColor || 'rgb(255, 255, 255)'} count={indicatorCount} size={height - 10} />
          </Animatable.View>
        </View>
      );
    case 'DotIndicator':
      return (
        <View
          ...
          <Animatable.View
            animation={animationType || 'fadeIn'}
            style={[styles.defaultSpinnerContainerStyle, customSpinnerStyle, styles.animatedViewStyle, animationStyle]}>
            <DotIndicator color={spinnerColor || 'rgb(255, 255, 255)'} count={indicatorCount} size={size} {...props} />
          </Animatable.View>
        </View>
      );
    case 'MaterialIndicator':
        ...
        return (
          <View
            ...
            <Animatable.View
              animation={animationType || 'fadeIn'}
              style={[styles.defaultSpinnerContainerStyle, customSpinnerStyle]}>
              <ActivityIndicator color={spinnerColor || 'rgb(255, 255, 255)'} size={height - 10} />
            </Animatable.View>
          </View>
        );
      }
      return (
        <View
          ...
          <Animatable.View
            animation={animationType || 'fadeIn'}
            style={[styles.defaultSpinnerContainerStyle, customSpinnerStyle]}>
            <MaterialIndicator color={spinnerColor || 'rgb(255, 255, 255)'} size={height - 10} />
          </Animatable.View>
        </View>
      );
    case 'PacmanIndicator':
      return (
        <View
          ...
          <Animatable.View
            animation={animationType || 'fadeIn'}
            style={[styles.defaultSpinnerContainerStyle, customSpinnerStyle]}>
            <PacmanIndicator color={spinnerColor || 'rgb(255, 255, 255)'} size={height - 10} />
          </Animatable.View>
        </View>
      );
    case 'PulseIndicator':
      return (
        <View
          ...
          <Animatable.View
            animation={animationType || 'fadeIn'}
            style={[styles.defaultSpinnerContainerStyle, customSpinnerStyle]}>
            <PulseIndicator color={spinnerColor || 'rgb(255, 255, 255)'} size={height} />
          </Animatable.View>
        </View>
      );
    case 'SkypeIndicator':
      ...
      return (
        <View
          ...
          <Animatable.View
            animation={animationType || 'fadeIn'}
            style={[styles.defaultSpinnerContainerStyle, customSpinnerStyle]}>
            <SkypeIndicator color={spinnerColor || 'rgb(255, 255, 255)'} count={indicatorCount} size={height - 10} />
          </Animatable.View>
        </View>
      );
    case 'UIActivityIndicator':
