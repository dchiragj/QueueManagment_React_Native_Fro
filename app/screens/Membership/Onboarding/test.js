...
//       Alert.alert('Success', 'Image uploaded: ' + result.imageUrl);
//     } catch (err) {
//       console.error(err);
...
// import authReducer from '@app/app/store/reducers/authReducer';
...
//   const profileInfo = props.profile.profileInfo;
...
//       uri: selectedImage.uri.startsWith('file://') ? selectedImage.uri : 'file://' + selectedImage.uri,
...
//     'http://192.168.2.11:8008/api/user/profile',
//     formData,
//     {
//       headers: {
